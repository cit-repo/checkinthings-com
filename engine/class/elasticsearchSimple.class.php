<?php
    ...
    class elasticsearchSimple {
         ...
         *
         */
        public function search($must, $must_not=false, $should=false, $from=0, $size=50)
        {
            $arMust = array();
            if ($must)
            ...
            $request = '{"query":{"bool":{"must":['.implode(",",$arMust).'],"must_not":['.implode(",",$arMustNot).'],"should":['.implode(",",$arShould).']}},"from":'.$from.',"size":'.$size.',"sort":[],"facets":{}}';
